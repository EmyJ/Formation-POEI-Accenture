...
select * from factures where date_facture between '01/06/2006' and '30/06/2006'
--4
...
--8
insert into clients values('LAC001','Mlle','AnneSoso','Lacroix','rue franklin','44800','st herblain','0202020202',null,1)
...
group by 
titre, substring(code_postal,1,2) 
with cube --permet d'obtenir les totaux pour chaque niveaux de regroupement (ici totaux par departement, puis par titre)
