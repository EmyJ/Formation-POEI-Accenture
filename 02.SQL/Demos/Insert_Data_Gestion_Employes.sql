...
insert into [Services] values ('DIRGE','Direction Générale')
insert into [Services] values ('INFOR','Informatique')
insert into [Services] values ('COMPT','Comptabilité')
insert into [Services] values ('ACHAT','Achat')
insert into [Services] values ('TECHN','Technique')
