...
public class EcranArticle extends JFrame implements ObservateurPanelBoutons {

	private static final long serialVersionUID = 1L;
	
	private static Logger loggerEcranArticle = LoggerFactory.getLogger("fr.eni.papeterie.ihm.EcranArticle"); 
	...
	/* Boutons */
	private PanelBouton panelBoutons;
	
	/* idArticle affiché à l'écran */
	private Integer idCourant;

	public EcranArticle() {
		//loggerEcranArticle.info("ca marche");
	...
	public void afficherNouveau() {
		...
		Ramette a = new Ramette(null, "", "", "", 0.0f, 0, 0, 1);
	...
	public JPanel getPanelBoutons() {
		if (panelBoutons == null) {
			panelBoutons = new PanelBouton();	
			panelBoutons.registerObserver(this);
		}
	...
	public Article getArticle() {
		...
		try {
			...
			loggerEcranArticle.error("ERREUR : " + e.getMessage());
		}
		return article;
	}
	...
	@Override
	public void clickSurBtPrecedent() {
		ArticleController.get().precedent();
	}

	@Override
	public void clickSurBtSuivant() {
		ArticleController.get().suivant();
	}

	@Override
	public void clickSurBtnSupprimer() {
		ArticleController.get().supprimer();
	}

	@Override
	public void clickSurBtnEnregistrer() {
		ArticleController.get().enregistrer();
	}

	@Override
	public void clickSurBtnNouveau() {
		ArticleController.get().nouveau();
	}
