...
public class ListeCourseDAOJdbcImpl implements ListeCourseDAO {
	...
	public void insert(ListeCourse listeCourse) throws BusinessException {
		if(listeCourse==null)
		{
			BusinessException businessException = new BusinessException(CodesResultatDAL.INSERT_OBJET_NULL);
		...
		{
			e.printStackTrace();
			BusinessException businessException = new BusinessException(CodesResultatDAL.INSERT_OBJET_ECHEC);
			throw businessException;
		}
	...
	public void deleteArticle(int idArticle) throws BusinessException {
		try(Connection cnx = ConnectionProvider.getConnection())
		{
			...
			e.printStackTrace();
			BusinessException businessException = new BusinessException(CodesResultatDAL.SUPPRESSION_ARTICLE_ERREUR);
			throw businessException;
		}
	...
	public void cocherArticle(int idArticle) throws BusinessException {
		try(Connection cnx = ConnectionProvider.getConnection())
		{
			...
			e.printStackTrace();
			BusinessException businessException = new BusinessException(CodesResultatDAL.COCHE_ARTICLE_ERREUR);
			throw businessException;
		}
	...
	public void decocherArticle(int idArticle) throws BusinessException {
		try(Connection cnx = ConnectionProvider.getConnection())
		{
			...
			e.printStackTrace();
			BusinessException businessException = new BusinessException(CodesResultatDAL.DECOCHE_ARTICLE_ERREUR);
			throw businessException;
		}
	...
	public void decocherListeCourse(int idListeCourse) throws BusinessException {
		try(Connection cnx = ConnectionProvider.getConnection())
		{
			...
			e.printStackTrace();
			BusinessException businessException = new BusinessException(CodesResultatDAL.DECOCHE_ARTICLES_ERREUR);
			throw businessException;
		}
