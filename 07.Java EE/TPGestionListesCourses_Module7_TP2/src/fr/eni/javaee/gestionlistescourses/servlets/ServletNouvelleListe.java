 ...
 * Exemple d'une servlete réalisant plusieurs fonctions
 */
@WebServlet( urlPatterns= { "/nouvelle", "/supprimer/article"} )
public class ServletNouvelleListe extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(request.getServletPath().equals("/supprimer/article"))
		{
			ListeCourseManager listeCourseManager=new ListeCourseManager();
